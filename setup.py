...
_MODULE_NAME = "tprofiler"
_PACKAGE_NAME = 'tprofiler'
...
setup(
    ...
    url='https://github.com/hansbug/tprofiler',
    ...
    # entry_points={
    #     'console_scripts': [
    #         'tprofiler=tprofiler.entry:tprofilercli'
    #     ]
    # },
    project_urls={
        'Bug Reports': 'https://github.com/hansbug/tprofiler/issues',
        'Source': 'https://github.com/hansbug/tprofiler',
        'Documentation': 'https://tprofiler.hansbug.org/',
    },
)
